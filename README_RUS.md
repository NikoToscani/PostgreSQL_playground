...
Анализ и статистика данных по P2P курсам программистов "Camp42".
...
Тебе нужно будет создать базу данных со знаниями о «Camp42» и написать процедуры и функции для получения информации, а также процедуры и триггеры для её изменения.
...
💡 [Нажми сюда](https://forms.yandex.ru/cloud/64182088eb61462532cee6b5/), **чтобы поделиться с нами обратной связью на этот проект**. Это анонимно и поможет команде Продукта сделать твоё обучение лучше.
