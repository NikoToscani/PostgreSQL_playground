# Info Manipulation and Retrival v1.0

Data analysis and statistics for "Camp42" - P2P programming camp.
...
You will need to create a database with data about "Camp42" and write procedures and functions to retrieve information, as well as procedures and triggers to change it.
